  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    ...
    if (message.channel.permissionsFor(role).has("SEND_MESSAGES")) {
      try {
        ...
        return reply(`<a:aRedTick:584866618039861249> I cannot lock channel because ${e}.`);
      }
      ...
      return reply("<a:aGreenTick:584866617780076576> This channel is now read-only.");
      ...
      try {
        ...
        return reply(`<a:aRedTick:584866618039861249> I cannot unlock channel because ${e}.`);
      }
      if (message.guild.settings.moderationLogs.toLowerCase() === "on") {
      ...
      return reply("<a:aGreenTick:584866617780076576> This channel has been unlocked.");
