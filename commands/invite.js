...
- Lutu's Invite Link:  https://discordapp.com/api/oauth2/authorize?client_id=${this.client.user.id}&permissions=8&scope=bot
...
- **__Support Server Invite__** Link: https://discord.gg/xYTfUqX
