...
class Report extends Command {
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    bans.findOne({
      ...
      if (!r) return reply("<a:aRedTick:584866618039861249> Looks like you are not on my ban list.");
      ...
      if (q.toLowerCase() === "yes") {
        ...
        if (t.length === 1) {
          ...
          links = "<a:aRedTick:584866618039861249> No Proof Specified!";
        }
        ...
        if (conf === false) return reply("<a:aRedTick:584866618039861249> Prompt timed out.");
        ...
        if (conf.toLowerCase() === "yes") {
          ...
          return reply("<a:aRedTick:584866618039861249> Aborted!");
        }
      }
    });
  }
