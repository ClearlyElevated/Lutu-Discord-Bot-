      ...
      Bans.findOne({
        ...
        if (s.checkpoint === "on") {
          ...
          if (!u.caseReason) {
            ...
            checkEmbed.addField("Status:", "<a:aGreenTick:584866617780076576> Clear! (Not On Global Ban-List)");
            checkEmbed.setColor("GREEN");
          }

          if (u.caseReason) {
            checkEmbed.setDescription("A new member just joined the server!");
            checkEmbed.addField("Status:", "<a:aRedTick:584866618039861249> Malicious user! (Banned on Global Ban-List)");
