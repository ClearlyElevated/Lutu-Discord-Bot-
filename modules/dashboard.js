...
module.exports = (client) => {
  ...
  app.get("/discord", (req, res) => {
    res.redirect("https://discord.io/underground_server");
  });

  app.get("/invite", (req, res) => {
    res.redirect("https://discordapp.com/oauth2/authorize?client_id=584279261368811520&permissions=8&scope=bot");
  });
  ...
  app.get("/staff", (req, res) => {
    renderTemplate(res, req, "staff.ejs", {
      "clearlyelevated": { "image": client.users.get("542058542853521461").displayAvatarURL() },
  ...
  app.post("/report", checkAuth, async (req, res) => {
    ...
    const reportEmbed = new Discord.MessageEmbed()
      ...
      .setColor("#36393e")
      .setTimestamp();
    client.channels.get("584320412083552266").send(reportEmbed);
  ...
  app.post("/dashboard/:guildID", checkAuth, async (req, res) => {
    ...
    const updatedObj = {
      ...
      moderationLogChannel: req.body["only-mod-channel"] || ""
    };
